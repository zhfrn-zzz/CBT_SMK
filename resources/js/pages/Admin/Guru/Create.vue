...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Guru', href: '/admin/guru/create' },
];
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-lg p-4">
            <PageHeader title="Tambah Guru" :icon="GraduationCap">
                <template #actions>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="password" v-model="form.password" type="password" placeholder="Kosongkan untuk auto-generate" />
                            <InputError :message="form.errors.password" />
                            <p class="text-xs text-muted-foreground">Jika dikosongkan, password akan digenerate otomatis.</p>
                        </div>
