...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <PageHeader title="Tambah Mata Pelajaran" :icon="BookOpen" />
                ...
                <CardContent class="p-6">
                    <form @submit.prevent="submit" class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <Input id="name" v-model="form.name" class="h-11" placeholder="Contoh: Administrasi Sistem Jaringan" />
                            <InputError :message="form.errors.name" />
                        </div>

                        <div class="space-y-2">
                            <Label for="code" class="font-semibold text-sm">Kode <span class="text-destructive">*</span></Label>
                            <Input id="code" v-model="form.code" class="h-11 max-w-[200px]" placeholder="Contoh: ASJ" />
